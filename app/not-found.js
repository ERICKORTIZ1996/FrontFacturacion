        ...
        >
            ...
            <div className="bg-gradient-to-t from-[#102940]/20 to-[#182a3b]/60 shadow shadow-gray-800 px-10 py-16 rounded-3xl w-[70%] flex flex-col items-center justify-center">
                ...
                >
                    ...
                    <h1 className="font-bold text-3xl text-center lg:text-start md:text-6xl uppercase">Error 404</h1>
                    <p className="mt-1 mb-6 text-center text-sm md:text-lg">La página que estás buscando se <br /> movió, renobó o podría <br /> no existir.</p>
