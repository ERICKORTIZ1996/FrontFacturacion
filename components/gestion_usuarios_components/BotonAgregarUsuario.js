...
export default function BotonAgregarUsuario() {
    ...
    return (
        <button
            type="button"
            className="flex items-center gap-3 bg-[#2e4760] rounded-xl px-3 py-1 hover:bg-[#3a546e] transition-colors cursor-pointer text-nowrap"
            onClick={() => changeModalCrearUsuario()}
        >
