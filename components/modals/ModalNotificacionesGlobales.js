        ...
        <>
            <Dialog open={modalNotificacionesGlobales} onClose={() => { changeModalNotificacionesGlobales() }} className="relative z-50">
                <div className="fixed inset-0 flex w-screen items-start justify-end p-4 bg-transparent">
                    ...
                    <DialogPanel className="w-[20%] space-y-4 px-3 py-1 rounded-3xl shadow shadow-[#245e95] bg-gradient-to-b from-[#153350] to-[#1f3850] mr-20">

                        <div
                            className='flex justify-between items-center gap-5 border-b border-b-[#486b8f] pb-1'
                        >
